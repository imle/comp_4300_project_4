...
${PROG_NAME}: ${PROG_NAME}.cpp ${OUT_DIR}/AbstractSectionParser.o ${OUT_DIR}/SectionParser.o ${OUT_DIR}/IntegerFU.o ${OUT_DIR}/FunctionalUnit.o ${OUT_DIR}/Memory.o ${OUT_DIR}/MemoryLoader.o ${OUT_DIR}/RegisterFile.o ${OUT_DIR}/ScoreBoard.o ${OUT_DIR}/Simulator.o ${OUT_DIR}/ArgumentParser.o ${OUT_DIR}/number_functions.o ${OUT_DIR}/string_functions.o ${OUT_DIR}/error_codes.o ${OUT_DIR}/types_data.o ${OUT_DIR}/opcode_data.o
